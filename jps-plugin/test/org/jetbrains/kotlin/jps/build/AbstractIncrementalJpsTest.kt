...
import org.jetbrains.kotlin.jps.incremental.LookupStorageTarget
...
public abstract class AbstractIncrementalJpsTest(
    ...
    private fun createLookupCacheDump(project: ProjectDescriptor): String {
        ...
        val lookupStorage = project.dataManager.getStorage(LookupStorageTarget, LookupStorageProvider)
