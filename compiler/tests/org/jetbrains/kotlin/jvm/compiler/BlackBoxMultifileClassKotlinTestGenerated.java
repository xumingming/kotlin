...
public class BlackBoxMultifileClassKotlinTestGenerated extends AbstractBlackBoxMultifileClassCodegenTest {
    ...
    public static class Calls extends AbstractBlackBoxMultifileClassCodegenTest {
        ...
        @TestMetadata("callXClassFromOtherPackage.1.kt")
        public void testCallXClassFromOtherPackage() throws Exception {
            String fileName = JetTestUtils.navigationMetadata("compiler/testData/codegen/boxMultifileClasses/calls/callXClassFromOtherPackage.1.kt");
            doTestMultifileClassAgainstSources(fileName);
        }
