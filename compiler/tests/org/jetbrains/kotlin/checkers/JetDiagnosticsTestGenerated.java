...
public class JetDiagnosticsTestGenerated extends AbstractJetDiagnosticsTest {
    ...
    public static class Tests extends AbstractJetDiagnosticsTest {
        ...
        public static class Annotations extends AbstractJetDiagnosticsTest {
            ...
            @TestMetadata("SpecialFileAnnotationNames.kt")
            public void testSpecialFileAnnotationNames() throws Exception {
                String fileName = JetTestUtils.navigationMetadata("compiler/testData/diagnostics/tests/annotations/SpecialFileAnnotationNames.kt");
                doTest(fileName);
            }

            @TestMetadata("SpecialFileAnnotationNamesOnImportAlias.kt")
            public void testSpecialFileAnnotationNamesOnImportAlias() throws Exception {
                String fileName = JetTestUtils.navigationMetadata("compiler/testData/diagnostics/tests/annotations/SpecialFileAnnotationNamesOnImportAlias.kt");
                doTest(fileName);
            }
