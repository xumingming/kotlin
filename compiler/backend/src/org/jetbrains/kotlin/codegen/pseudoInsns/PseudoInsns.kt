...
public fun InstructionAdapter.saveStackBeforeTryExpr() {
    PseudoInsn.SAVE_STACK_BEFORE_TRY.emit(this)
}

public fun InstructionAdapter.restoreStackInTryCatch() {
    PseudoInsn.RESTORE_STACK_IN_TRY_CATCH.emit(this)
}
