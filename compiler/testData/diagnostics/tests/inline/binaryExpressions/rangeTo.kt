...
inline operator fun <T, U> Function1<T, U>.rangeTo(p: Function1<T, U>): InclusiveRange<Int> {
    this..p
    p..this
    return 1..2
}
...
operator fun <T, U, V> Function2<T, U, V>.rangeTo(p: Function2<T, U, V>): InclusiveRange<Int> {
    return 1..2
}

operator fun <T, U, V, W> @Extension Function3<T, U, V, W>.rangeTo(ext: @Extension Function3<T, U, V, W>): InclusiveRange<Int> {
    return 1..2
}
