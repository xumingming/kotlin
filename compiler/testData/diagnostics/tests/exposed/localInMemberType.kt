...
class Something {
    ...
    public val <!PROPERTY_TYPE_DEPDENDS_ON_LOCAL_CLASS!>publicVal2<!> = run { class A; A() }
    protected val <!PROPERTY_TYPE_DEPDENDS_ON_LOCAL_CLASS!>protectedVal2<!> = run { class A; A() }
    internal val <!PROPERTY_TYPE_DEPDENDS_ON_LOCAL_CLASS!>internalVal2<!> = run { class A; A() }
