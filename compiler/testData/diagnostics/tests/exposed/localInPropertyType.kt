...
val <!PROPERTY_TYPE_DEPDENDS_ON_LOCAL_CLASS!>invalid1<!> = run {
    class Local
    My(Local())
}

val <!PROPERTY_TYPE_DEPDENDS_ON_LOCAL_CLASS!>invalid2<!> = My(object {})

val <!PROPERTY_TYPE_DEPDENDS_ON_LOCAL_CLASS!>invalid3<!> = My(object : Base() {})

val <!PROPERTY_TYPE_DEPDENDS_ON_LOCAL_CLASS!>invalid4<!> = run {
    class Local
    My(My(Local()))
}

val <!PROPERTY_TYPE_DEPDENDS_ON_LOCAL_CLASS!>invalid5<!> = run {
    fun invalid5a() = run {
        class Local
        Local()
    }
