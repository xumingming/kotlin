...
class ReplConsoleWriter : ReplWriter {
    ...
    override fun notifyReadLineStart() = Unit
    override fun notifyReadLineEnd() = Unit
    override fun notifyIncomplete() = Unit
    override fun notifyCommandSuccess() = Unit
    override fun sendInternalErrorReport(x: String) = Unit
