...
public class JVMConfigurationKeys {
    ...
    public static final CompilerConfigurationKey<Boolean> PACKAGE_FACADES_AS_FILE_FACADES =
            CompilerConfigurationKey.create("generate package facade classes as multi-file facade classes");
