...
public class CallCompleter(
    ...
    private fun completeOneArgument(
        ...
        val functionLiteralArgument = ArgumentTypeResolver.getFunctionLiteralArgumentIfAny(expression, context)
        ...
        // While the expected type is not known, ambiguous callable references to overloaded functions have placeholder types.
        // Now we should resolve them.
        val callableReferenceArgument = ArgumentTypeResolver.getCallableReferenceExpressionIfAny(expression, context)
        if (callableReferenceArgument != null) {
