...
public class ResolveSession implements KotlinCodeAnalyzer, LazyClassContext {
    ...
    private SupertypeLoopsResolver supertypeLoopsResolver;
    ...
    @NotNull
    @Override
    public SupertypeLoopsResolver getSupertypeLoopsResolver() {
        return supertypeLoopsResolver;
    }

    @Inject
    public void setSupertypeLoopsResolver(@NotNull SupertypeLoopsResolver supertypeLoopsResolver) {
