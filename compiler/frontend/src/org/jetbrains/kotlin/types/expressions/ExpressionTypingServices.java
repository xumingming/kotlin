...
public class ExpressionTypingServices {
    ...
    public JetType getShapeTypeOfCallableReference(
        ...
        JetType receiverType =
                CallableReferencesPackage.resolveCallableReferenceReceiverType(
                        callableReferenceExpression, context, expressionTypingComponents.typeResolver);
        OverloadResolutionResults<CallableDescriptor> overloadResolutionResults =
                CallableReferencesPackage.resolvePossiblyAmbiguousCallableReference(
                        ...
                        expressionTypingComponents.callResolver);
        return CallableReferencesPackage.getResolvedCallableReferenceShapeType(
                callableReferenceExpression, overloadResolutionResults, context, expectedTypeUnknown,
                expressionTypingComponents.reflectionTypes, expressionTypingComponents.builtIns);
    }
}
