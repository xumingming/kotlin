...
: KtWrappingLightClass(classOrObject.manager), JetJavaMirrorMarker, StubBasedPsiElement<KotlinClassOrObjectStub<out KtClassOrObject>> {
    ...
    private val _containingFile: PsiFile by lazy {
        ...
        object : FakeFileForLightClass(
                classOrObject.getContainingJetFile().packageFqName, virtualFile, myManager,
