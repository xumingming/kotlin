...
public fun MultifileClass(representativeFile: JetFile?, descriptor: PackageFragmentDescriptor, facadeFqName: FqName): JvmDeclarationOrigin =
        JvmDeclarationOrigin(MULTIFILE_CLASS, representativeFile, descriptor, facadeFqName)
public fun MultifileClassPart(file: JetFile, descriptor: PackageFragmentDescriptor, facadeFqName: FqName): JvmDeclarationOrigin =
        JvmDeclarationOrigin(MULTIFILE_CLASS_PART, file, descriptor, facadeFqName)
